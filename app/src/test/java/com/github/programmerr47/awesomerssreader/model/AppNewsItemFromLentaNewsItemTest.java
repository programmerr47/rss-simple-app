...
public class AppNewsItemFromLentaNewsItemTest {
    ...
    public static Collection<Object[]> data() {
        return asList(
                new Object[]{lentaItem(null, null, null, null), -1, null},
                new Object[]{lentaItem("Title 1", null, null, null), -1, null},
                new Object[]{lentaItem(null, "Test description 1 \u2131", null, null), -1, null},
                new Object[]{lentaItem(null, null, "Sat, 12 Nov 2016 09:58:00 +0300", null), 1478933880000L, null},
                new Object[]{lentaItem(null, null, null, TEST_URL), -1, TEST_URL},
                new Object[]{lentaItem(null, null, "Sat, 12 Nov 2016 08:27:00 +0300", TEST_URL), 1478928420000L, TEST_URL},
                new Object[]{lentaItem(null, "%20", null, TEST_URL), -1, TEST_URL},
                new Object[]{lentaItem("Title $4%#*()&@(%\\", "", "Sat, 12 Nov 2016 08:58:54 +0300", TEST_URL), 1478930334000L, TEST_URL});
    }
    ...
    public void checkConversionToAppNewsItem() {
        val item = AppNewsItem.create(lentaNewsItem);
